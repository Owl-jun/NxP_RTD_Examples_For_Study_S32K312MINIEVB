...
#define LCU_IP_PBCFG_AR_RELEASE_MINOR_VERSION_C         9
#define LCU_IP_PBCFG_AR_RELEASE_REVISION_VERSION_C      0
#define LCU_IP_PBCFG_SW_MAJOR_VERSION_C                 7
#define LCU_IP_PBCFG_SW_MINOR_VERSION_C                 0
#define LCU_IP_PBCFG_SW_PATCH_VERSION_C                 1
/* Check if Lcu_Ip_PBcfg.c file and Lcu_Ip_Cfg.h file are of the same vendor */
#if (LCU_IP_PBCFG_VENDOR_ID_C != LCU_IP_CFG_VENDOR_ID)
    #error "Lcu_Ip_PBcfg.c and Lcu_Ip_Cfg.h have different vendor ids"
#endif

/* Check if Lcu_Ip_PBcfg.c file and Lcu_Ip_Cfg.h file are of the same Autosar version */
...
/* Check if Lcu_Ip_PBcfg.c file and Lcu_Ip_Cfg.h file are of the same Software version */
