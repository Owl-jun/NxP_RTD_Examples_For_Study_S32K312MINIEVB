...
#define ETPU_PWM_IP_CFG_AR_RELEASE_MINOR_VERSION     9
#define ETPU_PWM_IP_CFG_AR_RELEASE_REVISION_VERSION  0
#define ETPU_PWM_IP_CFG_SW_MAJOR_VERSION             7
#define ETPU_PWM_IP_CFG_SW_MINOR_VERSION             0
#define ETPU_PWM_IP_CFG_SW_PATCH_VERSION             1
...
#define ETPU_PWM_IP_CHANNEL_COUNT       (0U)
...
/** @brief      Size of the Pwm eTPU memory block in Bytes */
#define ETPU_PWM_IP_BLOCK_SIZE          (0U)

/* Check if block size from resources is the same as in firmware */
#if (ETPU_PWM_IP_BLOCK_SIZE != ETPU_PWM_IP_NUM_PARMS)
    #error "Pwm block size definition in firmware and in resources are different."
#endif
