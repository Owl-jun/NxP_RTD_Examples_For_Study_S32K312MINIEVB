...
#define SIUL2_ICU_IP_DEFINES_AR_RELEASE_MINOR_VERSION       9
#define SIUL2_ICU_IP_DEFINES_AR_RELEASE_REVISION_VERSION    0
#define SIUL2_ICU_IP_DEFINES_SW_MAJOR_VERSION               7
...
#define SIUL2_ICU_IP_DEINIT_API                 (STD_OFF)
...
#define SIUL2_ICU_IP_GET_INPUT_STATE_API        (STD_OFF)
