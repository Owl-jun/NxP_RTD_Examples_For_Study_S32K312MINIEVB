...
#define UART_IPW_CFG_AR_RELEASE_MINOR_VERSION     9
#define UART_IPW_CFG_AR_RELEASE_REVISION_VERSION  0
#define UART_IPW_CFG_SW_MAJOR_VERSION             7
...
extern void App_Uart_Callback(uint8 HwInstance, Uart_EventType Event);
