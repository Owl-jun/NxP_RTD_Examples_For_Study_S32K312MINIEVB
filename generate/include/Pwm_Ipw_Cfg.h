...
#define PWM_IPW_CFG_AR_RELEASE_MINOR_VERSION          9
#define PWM_IPW_CFG_AR_RELEASE_REVISION_VERSION       0
#define PWM_IPW_CFG_SW_MAJOR_VERSION                  7
...
/** @brief        Switch to indicate that the fault notifications are supported */
#define PWM_FAULT_NOTIFICATION_SUPPORTED        (STD_OFF)

/** @brief        Switch to indicate that the DMA request is supported */
#define PWM_DMA_REQUEST_SUPPORTED               (STD_OFF)
...
#define PWM_IPW_FLEXIO_CHANNEL_OFFSET           (48U)

/** @brief        Offset to indicate FlexPwm channel location in hw to logic channel mapping */
#define PWM_IPW_FLEXPWM_CHANNEL_OFFSET          (56U)
