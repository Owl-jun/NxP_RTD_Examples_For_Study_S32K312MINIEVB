...
#define WDG_AR_RELEASE_MINOR_VERSION_CFG     9
#define WDG_AR_RELEASE_REVISION_VERSION_CFG  0
#define WDG_SW_MAJOR_VERSION_CFG             7
...
*                                     FILE VERSION CHECKS
==================================================================================================*/
/* Check if current file and Wdg_43_Instance0_PBcfg.h header file are of the same vendor */
