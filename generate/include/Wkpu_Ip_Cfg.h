...
/* Check if header file and Wkpu_Ip_Cfg.h and Wkpu_Ip_PBcfg.h file are of the same vendor */
#if (WKPU_IP_CFG_VENDOR_ID != WKPU_IP_PBCFG_VENDOR_ID)
    #error "Wkpu_Ip_Cfg.h and Wkpu_Ip_PBcfg.h have different vendor IDs"
#endif
/* Check if header file and Wkpu_Ip_PBcfg.h file are of the same Autosar version */
...
#endif
/* Check if header file and Wkpu_Ip_PBcfg.h file are of the same Software version */
