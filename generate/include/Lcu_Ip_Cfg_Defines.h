...
#define LCU_IP_CFG_DEFINES_AR_RELEASE_MINOR_VERSION        9
#define LCU_IP_CFG_DEFINES_AR_RELEASE_REVISION_VERSION     0
#define LCU_IP_CFG_DEFINES_SW_MAJOR_VERSION                7
...
/* LCU multi partitions */
#define LCU_IP_MULTIPARTITION_IS_AVAILABLE            STD_OFF
