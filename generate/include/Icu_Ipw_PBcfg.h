...
#define ICU_IPW_PBCFG_AR_RELEASE_MINOR_VERSION     9
#define ICU_IPW_PBCFG_AR_RELEASE_REVISION_VERSION  0
#define ICU_IPW_PBCFG_SW_MAJOR_VERSION             7
...
extern const Icu_Ipw_ChannelConfigType Icu_Ipw_IpChannelConfig_PB[1U];
extern const Icu_Ipw_IpConfigType Icu_Ipw_IpConfig_PB[1U];
