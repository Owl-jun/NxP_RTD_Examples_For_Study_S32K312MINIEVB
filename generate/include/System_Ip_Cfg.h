...
#define CDD_PLATFORM_SYSTEM_IP_CFG_SW_MAJOR_VERSION                   7
#define CDD_PLATFORM_SYSTEM_IP_CFG_SW_MINOR_VERSION                   0
#define CDD_PLATFORM_SYSTEM_IP_CFG_SW_PATCH_VERSION                   1
#define CDD_PLATFORM_SYSTEM_IP_CFG_AR_RELEASE_MAJOR_VERSION           4
#define CDD_PLATFORM_SYSTEM_IP_CFG_AR_RELEASE_MINOR_VERSION           9
