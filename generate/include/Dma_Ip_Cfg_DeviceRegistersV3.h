...
#define DMA_IP_CFG_DEVICEREGISTERSV3_AR_RELEASE_MINOR_VERSION        9
#define DMA_IP_CFG_DEVICEREGISTERSV3_AR_RELEASE_REVISION_VERSION     0
#define DMA_IP_CFG_DEVICEREGISTERSV3_SW_MAJOR_VERSION                7
...
/*==================================================================================================
                                       DMA TCD NOT ALIGNED
==================================================================================================*/
#define DMA_IP_TCD_HWV3_NOT_ALIGNED               STD_ON
...
#if (DMA_IP_TCD_HWV3_NOT_ALIGNED == STD_OFF)
typedef struct
{
    struct
    {
