...
#define DMA_IP_HWV3_ACCESSINLINE_AR_RELEASE_MINOR_VERSION        9
#define DMA_IP_HWV3_ACCESSINLINE_AR_RELEASE_REVISION_VERSION     0
#define DMA_IP_HWV3_ACCESSINLINE_SW_MAJOR_VERSION                7
#define DMA_IP_HWV3_ACCESSINLINE_SW_MINOR_VERSION                0
#define DMA_IP_HWV3_ACCESSINLINE_SW_PATCH_VERSION                1
...
static inline void hwv3AccInlineDmaInst_GetHRSActiveStatus(const Dma_Ip_Hwv3InstRegType * const ptInst, uint32 * const pValue)
{
    /* Get HRS register */
    *pValue = ptInst->reg_HRS;
}
...
static inline void hwv3AccInlineDmaCh_CmdClearInterruptStatus(Dma_Ip_ChRegType * ptCh)
{
    /* Access CH_INT register */
    uint32 reg = ptCh->reg_CH_INT;
    reg = (reg | DMA_IP_TCD_CH_INT_INT_MASK);
    ptCh->reg_CH_INT = reg;
}
/*==================================================================================================
