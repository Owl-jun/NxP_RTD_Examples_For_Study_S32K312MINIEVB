...
#define PWM_IPW_TYPES_AR_RELEASE_MINOR_VERSION          9
#define PWM_IPW_TYPES_AR_RELEASE_REVISION_VERSION       0
#define PWM_IPW_TYPES_SW_MAJOR_VERSION                  7
...
typedef enum
{
    /** @brief  The PWM pin will be in the same state of configured polarity */
    PWM_EMIOS_ACTIVE = 0,
    /** @brief  The PWM pin will be in the opposite state of configured polarity */
    PWM_EMIOS_INACTIVE
} Pwm_StateType;
#endif
...
#endif
    /** @brief  Channel type is Etpu */
    PWM_CHANNEL_ETPU                = 0x04U
} Pwm_IpwHwChannelType;

#if (PWM_FAULT_NOTIFICATION_SUPPORTED == STD_ON)
/**
* @brief        The fault interrupt source type
* @details      This enumeration defines the source of fault desired to generate the interrupt
*
*/
typedef enum
{
    /** @brief  Enables CPU interrupt requests generated by FlexPwm_0 instance, FAULT_0 input. */
    PWM_FLEXPWM_0_FAULT_INPUT_0 = 0U,
    /** @brief  Enables CPU interrupt requests generated by FlexPwm_0 instance, FAULT_1 input. */
    PWM_FLEXPWM_0_FAULT_INPUT_1 = 1U,
    /** @brief  Enables CPU interrupt requests generated by FlexPwm_0 instance, FAULT_2 input. */
    PWM_FLEXPWM_0_FAULT_INPUT_2 = 2U,
    /** @brief  Enables CPU interrupt requests generated by FlexPwm_0 instance, FAULT_3 input. */
    PWM_FLEXPWM_0_FAULT_INPUT_3 = 3U,
    /** @brief  Enables CPU interrupt requests generated by FlexPwm_1 instance, FAULT_0 input. */
    PWM_FLEXPWM_1_FAULT_INPUT_0 = 4U,
    /** @brief  Enables CPU interrupt requests generated by FlexPwm_1 instance, FAULT_1 input. */
    PWM_FLEXPWM_1_FAULT_INPUT_1 = 5U,
    /** @brief  Enables CPU interrupt requests generated by FlexPwm_1 instance, FAULT_2 input. */
    PWM_FLEXPWM_1_FAULT_INPUT_2 = 6U,
    /** @brief  Enables CPU interrupt requests generated by FlexPwm_1 instance, FAULT_3 input. */
    PWM_FLEXPWM_1_FAULT_INPUT_3 = 7U
} Pwm_FaultInterruptSourceType;
#endif
...
typedef struct
{
    ...
    const Etpu_Pwm_Ip_InstanceType         * EtpuPwmInstance;
    /** @brief  Pointer to the Etpu_Pwm ip channel configuration structure */
    const Etpu_Pwm_Ip_ConfigType           * EtpuChConfig;
#endif
