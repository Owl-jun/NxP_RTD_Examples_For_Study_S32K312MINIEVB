...
#define PWM_IPW_AR_RELEASE_MINOR_VERSION          9
#define PWM_IPW_AR_RELEASE_REVISION_VERSION       0
#define PWM_IPW_SW_MAJOR_VERSION                  7
...
extern Etpu_Pwm_Ip_ConfigType Pwm_Ipw_aEtpuConfig[ETPU_PWM_IP_ENGINE_COUNT][ETPU_PWM_IP_CHANNEL_COUNT];
...
/**
* @brief        Pwm_Ipw_DisableDmaRequest
...
#if (PWM_DMA_REQUEST_SUPPORTED == STD_ON)
/**
* @brief        Pwm_Ipw_EnableDmaRequest
...
#if ((PWM_DEV_ERROR_DETECT == STD_ON) && ((PWM_NOTIFICATION_SUPPORTED == STD_ON) || (PWM_DMA_REQUEST_SUPPORTED == STD_ON)))
/**
...
*
* @param[in]    FaultInterruptSource The fault interrupt source requested
*
* @return       Std_ReturnType
...
* @details      This function shall enable the PWM fault notification for the desired resource
*
* @param[in]    FaultInterruptSource        The resource of fault's desired to generate interrupt
