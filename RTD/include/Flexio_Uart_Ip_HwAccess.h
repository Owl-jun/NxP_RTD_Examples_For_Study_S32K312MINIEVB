...
#define FLEXIO_UART_IP_HWACCESS_AR_RELEASE_MINOR_VERSION     9
#define FLEXIO_UART_IP_HWACCESS_AR_RELEASE_REVISION_VERSION  0
#define FLEXIO_UART_IP_HWACCESS_SW_MAJOR_VERSION             7
#define FLEXIO_UART_IP_HWACCESS_SW_MINOR_VERSION             0
#define FLEXIO_UART_IP_HWACCESS_SW_PATCH_VERSION             1
 ...
 */
static inline void Flexio_Uart_Ip_SetTimerCompare(FLEXIO_Type * Base, uint8 Timer, uint32 Value)
{
...
static inline boolean Flexio_Uart_Ip_CheckTimeout(uint32 * StartTime, uint32 * ElapsedTicks, uint32 TimeoutTicks, OsIf_CounterType OsifCounter)
{
    ...
    if ((0xFFFFFFFFUL - *ElapsedTicks) >= CurrentElapsedTicks)
    {
        *ElapsedTicks += CurrentElapsedTicks;
    }
    else
    {
        *ElapsedTicks = 0xFFFFFFFFUL;
    }
