...
#define EMIOS_ICU_IP_TYPES_AR_RELEASE_MINOR_VERSION      9
#define EMIOS_ICU_IP_TYPES_AR_RELEASE_REVISION_VERSION   0
#define EMIOS_ICU_IP_TYPES_SW_MAJOR_VERSION              7
...
typedef struct
{
    ...
    eMios_Icu_Ip_CallbackType           callbackOverflow;           /*!< The HLD callback function for overflow channels events */
...
typedef struct
{
    ...
    /** @brief Calback for HLD callback function for overflow channels events.*/
    eMios_Icu_Ip_CallbackType                       callbackOverflow;
