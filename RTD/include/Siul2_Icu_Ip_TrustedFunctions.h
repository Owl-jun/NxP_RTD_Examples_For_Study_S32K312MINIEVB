...
#define SIUL2_ICU_IP_TRUSTEDFUNCTIONS_AR_RELEASE_MINOR_VERSION     9
#define SIUL2_ICU_IP_TRUSTEDFUNCTIONS_AR_RELEASE_REVISION_VERSION  0
#define SIUL2_ICU_IP_TRUSTEDFUNCTIONS_SW_MAJOR_VERSION             7
#define SIUL2_ICU_IP_TRUSTEDFUNCTIONS_SW_MINOR_VERSION             0
#define SIUL2_ICU_IP_TRUSTEDFUNCTIONS_SW_PATCH_VERSION             1
