...
#define EMIOS_PWM_IP_AR_RELEASE_MINOR_VERSION        9
#define EMIOS_PWM_IP_AR_RELEASE_REVISION_VERSION     0
#define EMIOS_PWM_IP_SW_MAJOR_VERSION                7
#define EMIOS_PWM_IP_SW_MINOR_VERSION                0
#define EMIOS_PWM_IP_SW_PATCH_VERSION                1
...
extern boolean eMios_Pwm_Ip_aDeInitChannelCalledByASR[EMIOS_PWM_IP_INSTANCE_COUNT];
