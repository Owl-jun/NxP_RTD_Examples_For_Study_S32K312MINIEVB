...
#define EMIOS_PWM_IP_HWACCESS_AR_RELEASE_MINOR_VERSION     9
#define EMIOS_PWM_IP_HWACCESS_AR_RELEASE_REVISION_VERSION  0
#define EMIOS_PWM_IP_HWACCESS_SW_MAJOR_VERSION             7
#define EMIOS_PWM_IP_HWACCESS_SW_MINOR_VERSION             0
#define EMIOS_PWM_IP_HWACCESS_SW_PATCH_VERSION             1
                                                                          ...
                                                                          )
{
    ...
    switch((Base->CH.UC[Channel].C & eMIOS_C_BSL_MASK) >> eMIOS_C_BSL_SHIFT)
    {
        case 0x00U:
            ...
            break;
        case 0x01U:
            CounterBus = EMIOS_PWM_IP_BUS_BCD;
            break;
        case 0x02U:
                                                   ...
                                                   )
{
    ...
    switch(Value)
    {
        ...
        case EMIOS_PWM_IP_BUS_BCD:
            TimbaseChannel = Channel & (uint8)EMIOS_PWM_IP_COUNTER_BUS_BCD;
            break;
        default:
