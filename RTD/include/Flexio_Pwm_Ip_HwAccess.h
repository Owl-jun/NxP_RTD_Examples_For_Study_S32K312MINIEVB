...
#define FLEXIO_PWM_IP_HWACCESS_AR_RELEASE_MINOR_VERSION     9
#define FLEXIO_PWM_IP_HWACCESS_AR_RELEASE_REVISION_VERSION  0
#define FLEXIO_PWM_IP_HWACCESS_SW_MAJOR_VERSION             7
#define FLEXIO_PWM_IP_HWACCESS_SW_MINOR_VERSION             0
#define FLEXIO_PWM_IP_HWACCESS_SW_PATCH_VERSION             1
