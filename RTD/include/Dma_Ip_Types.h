...
#define DMA_IP_TYPES_AR_RELEASE_MINOR_VERSION        9
#define DMA_IP_TYPES_AR_RELEASE_REVISION_VERSION     0
#define DMA_IP_TYPES_SW_MAJOR_VERSION                7
#define DMA_IP_TYPES_SW_MINOR_VERSION                0
#define DMA_IP_TYPES_SW_PATCH_VERSION                1
