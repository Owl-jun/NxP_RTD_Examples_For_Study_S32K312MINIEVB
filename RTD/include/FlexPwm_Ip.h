...
#define FLEXPWM_IP_AR_RELEASE_MINOR_VERSION        9
#define FLEXPWM_IP_AR_RELEASE_REVISION_VERSION     0
#define FLEXPWM_IP_SW_MAJOR_VERSION                7
#define FLEXPWM_IP_SW_MINOR_VERSION                0
#define FLEXPWM_IP_SW_PATCH_VERSION                1
...
extern boolean FlexPwm_Ip_aDeInitCalledByASR[FLEXPWM_IP_INSTANCE_COUNT_U8];
