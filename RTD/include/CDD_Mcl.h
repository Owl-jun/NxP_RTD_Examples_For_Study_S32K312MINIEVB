...
#define CDD_MCL_AR_RELEASE_MINOR_VERSION        9
#define CDD_MCL_AR_RELEASE_REVISION_VERSION     0
#define CDD_MCL_SW_MAJOR_VERSION                7
#define CDD_MCL_SW_MINOR_VERSION                0
#define CDD_MCL_SW_PATCH_VERSION                1
...
extern uint8 Mcl_au8EmiosLogicToHwInstance[eMIOS_INSTANCE_COUNT];
...
typedef enum
{
    ...
    MCL_LCU_IP_INPUT_SET_SW_OVERRIDE_EN         = 1U,   /**< @brief [SWEN] Software override input enable */
    MCL_LCU_IP_INPUT_SET_SW_VALUE               = 2U    /**< @brief [SWVALUE] Software override input value */
...
typedef struct
{
    ...
    boolean HRS_present;                   /**< @brief [BOOLEAN] The HRS present value is read from the DMA Instance Hardware Request Status register (HRS) filed HRS<0:15>. */
 ...
 *
 * @param Channel       Should be used the generated define MCL_EMIOS_LOGIC_CH[number]
 ...
 *
 * @param logicalChannel Should be used the generated define MCL_EMIOS_LOGIC_CH[number]
 *                          - [number] can be indentied by (uint16)((0U << hwNumber) + hwChannel) from define
 *                     A list with this generated defines can be found on Emios_Mcl_Ip_Cfg_Defines.h
 ...
 *          input. When enable multi partitions, the API shall write the values into the register only
 ...
 *          for each LC input. When enable multi partitions, the API shall write the values into the
 ...
 *          When enable multi partitions, the API shall write the values into the register only if the
 ...
 *          operation in Debug mode. When enable multi partitions, the API shall write the values into
 ...
 *          enable multi partitions, the API shall write the values into the register only if the list
 ...
 *          output. When enable multi partitions, the API shall write the values into the register only
 ...
 *          force events for output. When enable multi partitions, the API shall write the values into
 *          the register only if the list contains all the Outputs related to the same partition
 *
 *          How to use this interface:
 *          List[x].LogicOutputId -> The Logic Output Id generated by the configurator
 ...
 *          Force signal. When enable multi partitions, the API shall write the values into the
 ...
 *          DMA request when a force event occurs. When enable multi partitions, the API shall write
 ...
 *          interrupt request when force event occurs. When enable multi partitions, the API shall
 ...
 *          LUT event occurs.
 * @details This service is a reentrant function that shall Enables/Disable the generation of a
 *          DMA request when a LUT event occurs. When enable multi partitions, the API shall write the
 ...
 *          LUT event occurs.
 * @details This service is a reentrant function that shall Enables/Disable the generation of an
 *          interrupt request when LUT event occurs. When enable multi partitions, the API shall write
 *          the values into the register only if the list contains all the Outputs related to the
 *          same partition
 *
 *          How to use this interface:
 ...
 * */
void Mcl_ClearLcuSyncOutputForceEvent(const Mcl_LcuSyncOutputValueType List[],
                                      const uint8 Dimension
                                     );
 ...
 *          When enable multi partitions, the API shall get the values from the register only if the
 *          list contains all the Inputs related to the same partition
 *
 *          How to use this interface:
