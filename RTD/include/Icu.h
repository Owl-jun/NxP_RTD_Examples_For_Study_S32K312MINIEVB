...
#define ICU_AR_RELEASE_MINOR_VERSION        9
#define ICU_AR_RELEASE_REVISION_VERSION     0
#define ICU_SW_MAJOR_VERSION                7
...
#if ((ICU_VALIDATE_PARAMS == STD_ON) && ((ICU_TIMESTAMP_API == STD_ON) || (ICU_GET_DUTY_CYCLE_VALUES_API == STD_ON)))
/**
