...
#define FLEXIO_PWM_IP_AR_RELEASE_MINOR_VERSION     9
#define FLEXIO_PWM_IP_AR_RELEASE_REVISION_VERSION  0
#define FLEXIO_PWM_IP_SW_MAJOR_VERSION             7
#define FLEXIO_PWM_IP_SW_MINOR_VERSION             0
#define FLEXIO_PWM_IP_SW_PATCH_VERSION             1
...
extern const Flexio_Pwm_Ip_ChannelConfigType * Flexio_Pwm_Ip_aState[FLEXIO_PWM_IP_INSTANCE_COUNT][FLEXIO_PWM_IP_CHANNEL_COUNT];
...
extern boolean Flexio_Pwm_Ip_aDeInitChannelCalledByASR[FLEXIO_PWM_IP_INSTANCE_COUNT];
