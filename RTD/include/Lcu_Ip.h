...
#define LCU_IP_AR_RELEASE_MINOR_VERSION        9
#define LCU_IP_AR_RELEASE_REVISION_VERSION     0
#define LCU_IP_SW_MAJOR_VERSION                7
#define LCU_IP_SW_MINOR_VERSION                0
#define LCU_IP_SW_PATCH_VERSION                1
...
typedef enum
{
    ...
    LCU_IP_INPUT_SET_SW_OVERRIDE_EN         = 1U,   /**< @brief [SWEN] Software override input enable */
    LCU_IP_INPUT_SET_SW_VALUE               = 2U    /**< @brief [SWVALUE] Software override input value */
 ...
 *          When enable multi partitions, the API shall write the values into the register only
 *          if the reference partition is same with executing core
 *
 * @param[in]  pxLcuInit         Pointer to the configuration structure.
 *
 * @return Lcu_Ip_ReturnType LCU_IP_STATUS_WRONG_PARTITION is returned if enable the multi-partitions feature and the reference partition is same with executing core.
 ...
 *
 * @return Lcu_Ip_ReturnType LCU_IP_STATUS_WRONG_PARTITION is returned if enable the multi-partitions feature and at least one Input in the List has the incorrect partition.
 *                           LCU_IP_STATUS_SUCCESS is returned in the remaining cases
 *
 ...
 * @param[in]  Dimension    Number of entries in the List
 *
 * @return Lcu_Ip_ReturnType LCU_IP_STATUS_WRONG_PARTITION is returned if enable the multi-partitions feature and at least one Output in the List has the incorrect partition.
 *                           LCU_IP_STATUS_SUCCESS is returned in the remaining cases
 *
 ...
 * @param[in]  Dimension     Number of entries in the List
 *
 * @return Lcu_Ip_ReturnType LCU_IP_STATUS_WRONG_PARTITION is returned if enable the multi-partitions feature and the LogicInput incorrect partition.
 *                           LCU_IP_STATUS_SUCCESS is returned in the remaining cases
 *
