...
#define FLEXIO_IP_HW_ACCESS_AR_RELEASE_MINOR_VERSION       9
#define FLEXIO_IP_HW_ACCESS_AR_RELEASE_REVISION_VERSION    0
#define FLEXIO_IP_HW_ACCESS_SW_MAJOR_VERSION               7
#define FLEXIO_IP_HW_ACCESS_SW_MINOR_VERSION               0
#define FLEXIO_IP_HW_ACCESS_SW_PATCH_VERSION               1
 ...
 */
static inline uint32 Flexio_Mcl_Ip_GetAllPinsStatus(const FLEXIO_Type *baseAddr)
{
 ...
 */
static inline uint32 Flexio_Mcl_Ip_GetAllPinsInterrupt(const FLEXIO_Type *baseAddr)
{
 ...
 * counter to reload with the value in the compare register.
 */
static inline boolean Flexio_Mcl_Ip_GetTimerStatus(const FLEXIO_Type *baseAddr, uint8 timer)
{
    return ((((baseAddr->TIMSTAT >> timer) & 1U) != 0U) ? TRUE : FALSE);
}

#endif /* #if (STD_ON == FLEXIO_MCL_IP_PIN_STS_IS_AVAILABLE) */

static inline boolean Flexio_Mcl_Ip_GetTimerInterruptEnable(const FLEXIO_Type *baseAddr, uint8 timer)
{
 ...
 * counter to reload with the value in the compare register.
 */
static inline uint32 Flexio_Mcl_Ip_GetAllTimerStatus(const FLEXIO_Type *baseAddr)
{
 ...
 */
static inline void Flexio_Mcl_Ip_ClearTimerStatus(FLEXIO_Type *baseAddr, uint8 timer)
{
 ...
 */
static inline uint32 Flexio_Mcl_Ip_GetAllShifterInterrupt(const FLEXIO_Type *baseAddr)
{
 ...
 * shifter 0 from least significant bit.
 */
static inline uint32 Flexio_Mcl_Ip_GetAllShifterErrorInterrupt(const FLEXIO_Type *baseAddr)
{
 ...
 * timer 0 from least significant bit.
 */
static inline uint32 Flexio_Mcl_Ip_GetAllTimerInterrupt(const FLEXIO_Type *baseAddr)
{
