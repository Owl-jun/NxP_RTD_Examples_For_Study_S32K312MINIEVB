...
#define EMIOS_MCL_IP_AR_RELEASE_MINOR_VERSION     9
#define EMIOS_MCL_IP_AR_RELEASE_REVISION_VERSION  0
#define EMIOS_MCL_IP_SW_MAJOR_VERSION             7
...
/* Check if header file and Std_Types.h are of the same AUTOSAR version */
    ...
    #error "AUTOSAR Version Numbers of Emios_Mcl_Ip.h and Std_Types.h are different"
#endif
