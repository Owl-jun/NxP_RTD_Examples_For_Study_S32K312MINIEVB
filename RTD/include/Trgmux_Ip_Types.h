...
#define TRGMUX_IP_TYPES_AR_RELEASE_MINOR_VERSION     9
#define TRGMUX_IP_TYPES_AR_RELEASE_REVISION_VERSION  0
#define TRGMUX_IP_TYPES_SW_MAJOR_VERSION             7
#define TRGMUX_IP_TYPES_SW_MINOR_VERSION             0
#define TRGMUX_IP_TYPES_SW_PATCH_VERSION             1
...
typedef struct{
    const Trgmux_Ip_LogicTriggerType * const * paxLogicTrigger;
    uint8 NumOfLogicTriger;
    const uint8 * paxLogicInstance;
    uint8 NumOfLogicInstance;
}Trgmux_Ip_InitType;
