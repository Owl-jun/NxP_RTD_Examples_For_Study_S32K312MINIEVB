...
#define LCU_IP_TYPES_AR_RELEASE_MINOR_VERSION        9
#define LCU_IP_TYPES_AR_RELEASE_REVISION_VERSION     0
#define LCU_IP_TYPES_SW_MAJOR_VERSION                7
#define LCU_IP_TYPES_SW_MINOR_VERSION                0
#define LCU_IP_TYPES_SW_PATCH_VERSION                1
...
typedef enum{
    ...
    LCU_IP_STATUS_WRONG_PARTITION   = 3U,
...
typedef struct{
    ...
    const uint8 NumOfLogicInstance;
    const uint8 NumOfLogicInput;
    const uint8 NumOfLogicOutput;
}Lcu_Ip_InitType;
