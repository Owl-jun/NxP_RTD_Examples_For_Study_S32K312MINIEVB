...
#define FLEXPWM_IP_TYPES_AR_RELEASE_MINOR_VERSION              9
#define FLEXPWM_IP_TYPES_AR_RELEASE_REVISION_VERSION           0
#define FLEXPWM_IP_TYPES_SW_MAJOR_VERSION                      7
#define FLEXPWM_IP_TYPES_SW_MINOR_VERSION                      0
#define FLEXPWM_IP_TYPES_SW_PATCH_VERSION                      1
...
typedef enum
{
    ...
    FLEXPWM_IP_FAULT_INT    = 3U    /*!< Fault Interrupt */
...
typedef struct
{
    ...
    FlexPwm_Ip_OuputTriggerTypes   OutputTrig;          /*!< Define the Output trigger configuration for FlexPWM channels. */
...
typedef struct
{
    ...
    FlexPwm_Ip_FaultCallbackType   FaultNotification[FLEXPWM_IP_FAULT_CHANNELS_NO_U8]; /*!< Fault notification callbacks */
