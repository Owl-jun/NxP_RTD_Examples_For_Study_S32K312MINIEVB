...
#define PWM_AR_RELEASE_MINOR_VERSION        9
#define PWM_AR_RELEASE_REVISION_VERSION     0
#define PWM_SW_MAJOR_VERSION                7
...
/**
* @brief            Generated when the fault interrupt resource is out of range supported by platform.
* @details
*/
#define PWM_E_PARAM_FAULTINTERRUPTSOURCE_RANGE      (0x3FU)

/**
* @brief            Generated when the requested resource is configured to be unavailable on the current partition.
* @details          Only multi-partition configuration is available.
*/
...
* @details
*/
#define PWM_E_CHANNEL_FLAG_REQUEST_INVALID          (0x44U)
...
/**
* @brief            API service ID of Pwm_DisableDmaRequest function
* @details          Parameters used when raising an error/exception
*/
#define PWM_DISABLEDMAREQUEST_ID                   (0x44U)

/**
* @brief            API service ID of Pwm_EnableDmaRequest function
* @details          Parameters used when raising an error/exception
*/
#define PWM_ENABLEDMAREQUEST_ID                    (0x45U)
