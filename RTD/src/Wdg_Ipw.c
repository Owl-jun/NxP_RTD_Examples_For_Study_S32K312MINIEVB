...
#define WDG_IPW_AR_RELEASE_MINOR_VERSION_C       9
#define WDG_IPW_AR_RELEASE_REVISION_VERSION_C    0
#define WDG_IPW_SW_MAJOR_VERSION_C               7
#define WDG_IPW_SW_MINOR_VERSION_C               0
#define WDG_IPW_SW_PATCH_VERSION_C               1
...
Std_ReturnType Wdg_Ipw_SetMode(Wdg_Ipw_InstanceType Instance, const Wdg_Ipw_ConfigType * const IpwConfig)
{
    ...
    switch (Wdg_Ipw_aeIp[Instance])
    {
        ...
        case WDG_IPW_AEWDOG_IP:
            ...
            /* Reconfig window of aeWdog with the instance of AeWdog depending on the instance of Ae (m24x, m27x only has one instance of aeWdog) */
            if (AeWdog_Ip_ConfigWindow((uint8)0, IpwConfig->pAeWdogConfig->eWindowDutyCycle, IpwConfig->pAeWdogConfig->eWindowPeriod) != AEWDOG_IP_STATUS_SUCCESS)
            {
                Ret = (Std_ReturnType) E_NOT_OK;
            }
            break;
