...
#define PWM_AR_RELEASE_MINOR_VERSION_C          9
#define PWM_AR_RELEASE_REVISION_VERSION_C       0
#define PWM_SW_MAJOR_VERSION_C                  7
...
#include "Pwm_MemMap.h"
     ...
     (PWM_DMA_REQUEST_SUPPORTED            == STD_ON) || \
...
static inline Std_ReturnType Pwm_ValidateFaultInterruptSource(Pwm_FaultInterruptSourceType FaultInterruptSource,
                                                              uint8                        ServiceId
                                                             );
                                                     ...
                                                     )
{
    ...
    {
    #if (PWM_MULTIPARTITION_ENABLED == STD_ON)
        if (PWM_MAX_PARTITION_NO <= PartitionId)
        {
            (void)Det_ReportError
            (
                (uint16) PWM_MODULE_ID,
        ...
        else if (NULL_PTR == Pwm_Config[PartitionId])
        {
            /* Avoid compiler warning */
            (void)PartitionId;
...
#if (PWM_FAULT_NOTIFICATION_SUPPORTED == STD_ON)
/**
* @brief            Pwm_ValidateFaultInterruptSource
...
* @param[in]        ServiceId                           Service ID
*
* @retval           RetVal          E_NOT_OK  The fault interrupt source is not valid
                                                             ...
                                                             )
{
    ...
    RetVal = Pwm_Ipw_ValidateFaultInterruptSource(FaultInterruptSource);
    ...
    if((Std_ReturnType)E_OK != RetVal)
    {
        ...
        (
            ...
            (uint8)  PWM_INDEX,
            (uint8)  ServiceId,
            (uint8)  PWM_E_PARAM_FAULTINTERRUPTSOURCE_RANGE
        );
    }
...
/**
* @brief            Pwm_ValidateChannelFlagRequest
* @details          This function will check the validity of the hardware channel flag request for a given channel.
*                   Pwm_EnableNotification and Pwm_DisableNotification shall be called only for channels configured for interrupt request.
*                   Pwm_EnableDmaRequest and Pwm_DisableDmaRequest shall be called only for channels configured for DMA request.
*                   An error is reported if the channel is not configured for the proper requested flag type when calling these functions.
*
* @param[in]        PartitionId      The Index of current partition
* @param[in]        ChannelNumber    The id of channel number
* @param[in]        ServiceId        Service ID
*
* @retval           RetVal          E_NOT_OK  The call is not valid
                                    E_OK      The call is valid
*/
static inline Std_ReturnType Pwm_ValidateChannelFlagRequest(uint32            PartitionId,
                                                            Pwm_ChannelType   ChannelNumber,
                                                            uint8             ServiceId
                                                            )
{
    ...
    RetVal = Pwm_Ipw_ValidateChannelFlagRequest(&((*Pwm_aState[PartitionId].PwmChannelConfigs)[ChannelNumber].IpwChannelCfg),
                                                ServiceId
                                                );
    ...
    if((Std_ReturnType)E_OK != RetVal)
    {
        ...
        (
            ...
            (uint8)  PWM_INDEX,
            (uint8)  ServiceId,
            (uint8)  PWM_E_CHANNEL_FLAG_REQUEST_INVALID
        );
    }
...
#if (PWM_POWER_STATE_SUPPORTED == STD_ON)
            Pwm_eCurrentPowerState[PartitionId] = PWM_FULL_POWER;
...
#if (PWM_POWER_STATE_SUPPORTED == STD_ON)
        /* Reset Power State */
        Pwm_eCurrentPowerState[PartitionId] = PWM_NODEFINE_POWER;
        Pwm_eTargetPowerState[PartitionId]  = PWM_NODEFINE_POWER;
#endif
...
#endif
            /* All validations passed. Here starts the actual functional code of the function */
            (void)Pwm_Ipw_SetDutyCycle(DutyCycle, &((*Pwm_aState[PartitionId].PwmChannelConfigs)[PartitionChannelIdx].IpwChannelCfg));
...
#if (PWM_PARAM_CHECK == STD_ON)
        if ((Std_ReturnType)E_OK == Pwm_ValidateChannelFlagRequest(PartitionId, PartitionChannelIdx, PWM_DISABLENOTIFICATION_ID))
        {
#endif
        /* All validations passed. Here starts the actual functional code of the function */
                           ...
                           )
{
    ...
    if ((Std_ReturnType)E_OK == Pwm_ValidateChannelConfigCall(PartitionId, ChannelNumber, PWM_ENABLENOTIFICATION_ID))
    {
        ...
        {
            if ((Std_ReturnType)E_OK == Pwm_ValidateChannelFlagRequest(PartitionId, PartitionChannelIdx, PWM_ENABLENOTIFICATION_ID))
            {
#endif
                /* All validations passed. Here starts the actual functional code of the function */
...
/**
* @brief        This function disables the DMA requests for Emios channels.
* @details      The function Pwm_DisableDmaRequest shall disable the DMA requests for Emios channels
*               configured with EMIOS_PWM_IP_DMA_REQUEST.
*
*               If development error detection for the Pwm module is enabled:
*               - The PWM functions shall check the parameter ChannelNumber and raise
*               development error PWM_E_PARAM_CHANNEL if the parameter ChannelNumber is invalid.
...
* @return       void
*
* @implements   Pwm_DisableDmaRequest_Activity
*
*/
void Pwm_DisableDmaRequest(Pwm_ChannelType ChannelNumber)
{
    uint32          PartitionId;
    Pwm_ChannelType PartitionChannelIdx;
...
#if (PWM_VALIDATE_CHANNEL_CONFIG_CALL == STD_ON)
    if ((Std_ReturnType)E_OK == Pwm_ValidateChannelConfigCall(PartitionId, ChannelNumber, PWM_DISABLEDMAREQUEST_ID))
    {
#endif
        PartitionChannelIdx = Pwm_GetPartitionChannelIdx(PartitionId, ChannelNumber);

#if (PWM_PARAM_CHECK == STD_ON)
        if ((Std_ReturnType)E_OK == Pwm_ValidateChannelFlagRequest(PartitionId, PartitionChannelIdx, PWM_DISABLEDMAREQUEST_ID))
        {
#endif
        /* All validations passed. Here starts the actual functional code of the function */
        Pwm_Ipw_DisableDmaRequest(&((*Pwm_aState[PartitionId].PwmChannelConfigs)[PartitionChannelIdx].IpwChannelCfg));
#if (PWM_PARAM_CHECK == STD_ON)
        }
#endif
...
#if (PWM_DMA_REQUEST_SUPPORTED == STD_ON)
/**
* @brief        This function enables the DMA requests for Emios channels.
* @details      The function Pwm_EnableDmaRequest shall enable the DMA requests for Emios channels
*               configured with EMIOS_PWM_IP_DMA_REQUEST.
*
*               If development error detection for the Pwm module is enabled:
*               - The PWM functions shall check the parameter ChannelNumber and raise
...
* @return       void
*
* @implements   Pwm_EnableDmaRequest_Activity
*
*/
void Pwm_EnableDmaRequest(Pwm_ChannelType ChannelNumber)
{
    uint32          PartitionId;
    Pwm_ChannelType PartitionChannelIdx;
...
#if (PWM_VALIDATE_CHANNEL_CONFIG_CALL == STD_ON)
    if ((Std_ReturnType)E_OK == Pwm_ValidateChannelConfigCall(PartitionId, ChannelNumber, PWM_ENABLEDMAREQUEST_ID))
    {
#endif
        PartitionChannelIdx = Pwm_GetPartitionChannelIdx(PartitionId, ChannelNumber);

#if (PWM_PARAM_CHECK == STD_ON)
        if ((Std_ReturnType)E_OK == Pwm_ValidateChannelFlagRequest(PartitionId, PartitionChannelIdx, PWM_ENABLEDMAREQUEST_ID))
        {
#endif
        /* All validations passed. Here starts the actual functional code of the function */
        Pwm_Ipw_EnableDmaRequest(&((*Pwm_aState[PartitionId].PwmChannelConfigs)[PartitionChannelIdx].IpwChannelCfg));
#if (PWM_PARAM_CHECK == STD_ON)
        }
#endif
...
*
* @return       void
* @implements Pwm_SetCounterBus_Activity
*
*/
...
*
* @return       void
* @implements Pwm_SetChannelOutput_Activity
*
*/
...
#endif
            /* All validations passed. Here starts the actual functional code of the function */
            (void)Pwm_Ipw_SetDutyCycle_NoUpdate(DutyCycle, &((*Pwm_aState[PartitionId].PwmChannelConfigs)[PartitionChannelIdx].IpwChannelCfg));
...
*               If development error detection for the Pwm module is enabled:
*               - The PWM functions shall check the parameter FaultInterruptSource and raise
*               development error PWM_E_PARAM_FAULTINTERRUPTSOURCE_RANGE if the parameter FaultInterruptSource is invalid.
*
*               If development error detection for the Pwm module is enabled, when a development error
*               occurs, the corresponding PWM function shall:
*                   - Report the error to the Development Error Tracer.
...
* @return       void
*
* @implements   Pwm_EnableFaultNotification_Activity
*
*/
void Pwm_EnableFaultNotification(Pwm_FaultInterruptSourceType FaultInterruptSource)
{
#if (PWM_VALIDATE_GLOBAL_CONFIG_CALL == STD_ON)
    Std_ReturnType              CallIsValid;
    uint32                      PartitionId;
    ...
    /* Get partition Id of current processor */
    PartitionId = Pwm_GetPartitionId();
    CallIsValid = Pwm_ValidateGlobalConfigCall(PartitionId, PWM_ENABLEFAULTNOTIF_ID);
...
#if (PWM_PARAM_CHECK == STD_ON)
        if ((Std_ReturnType)E_OK == Pwm_ValidateFaultInterruptSource(FaultInterruptSource, PWM_ENABLEFAULTNOTIF_ID))
        {
#endif
            /* All validations passed. Here starts the actual functional code of the function */
            Pwm_Ipw_EnableFaultNotification(FaultInterruptSource);
    ...
    Pwm_EndValidateGlobalConfigCall(PartitionId, CallIsValid, PWM_ENABLEFAULTNOTIF_ID);
#endif
...
* @return       void
*
* @implements   Pwm_DisableFaultNotification_Activity
*
*/
void Pwm_DisableFaultNotification(Pwm_FaultInterruptSourceType FaultInterruptSource)
{
#if (PWM_VALIDATE_GLOBAL_CONFIG_CALL == STD_ON)
    Std_ReturnType              CallIsValid;
    uint32                      PartitionId;
    ...
    /* Get partition Id of current processor */
    PartitionId = Pwm_GetPartitionId();
    CallIsValid = Pwm_ValidateGlobalConfigCall(PartitionId, PWM_DISABLEFAULTNOTIF_ID);
...
#if (PWM_PARAM_CHECK == STD_ON)
        if ((Std_ReturnType)E_OK == Pwm_ValidateFaultInterruptSource(FaultInterruptSource, PWM_DISABLEFAULTNOTIF_ID))
        {
#endif

            /* All validations passed. Here starts the actual functional code of the function */
            Pwm_Ipw_DisableFaultNotification(FaultInterruptSource);
    ...
    Pwm_EndValidateGlobalConfigCall(PartitionId, CallIsValid, PWM_DISABLEFAULTNOTIF_ID);
#endif
