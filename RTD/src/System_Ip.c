...
#define CDD_PLATFORM_SYSTEM_IP_AR_RELEASE_MINOR_VERSION_C           9
#define CDD_PLATFORM_SYSTEM_IP_AR_RELEASE_REVISION_VERSION_C        0
#define CDD_PLATFORM_SYSTEM_IP_SW_MAJOR_VERSION_C                   7
#define CDD_PLATFORM_SYSTEM_IP_SW_MINOR_VERSION_C                   0
#define CDD_PLATFORM_SYSTEM_IP_SW_PATCH_VERSION_C                   1
