...
#define DMA_IP_IRQ_AR_RELEASE_MINOR_VERSION_C        9
#define DMA_IP_IRQ_AR_RELEASE_REVISION_VERSION_C     0
#define DMA_IP_IRQ_SW_MAJOR_VERSION_C                7
#define DMA_IP_IRQ_SW_MINOR_VERSION_C                0
#define DMA_IP_IRQ_SW_PATCH_VERSION_C                1
...
#if (STD_ON == DMA_IP_MULTIPARTITION_IS_AVAILABLE)
    Dma_Ip_ReturnType MultipartitionStatus = DMA_IP_STATUS_ERROR;
    Dma_Ip_HwChannelStateType * HwChannelStatePtr = NULL_PTR;
#endif /* STD_ON == DMA_IP_MULTIPARTITION_IS_AVAILABLE */
