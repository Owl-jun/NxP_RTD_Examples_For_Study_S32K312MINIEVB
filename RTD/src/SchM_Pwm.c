...
#define SCHM_PWM_SW_MAJOR_VERSION_C             7
...
static volatile uint32 msr_PWM_EXCLUSIVE_AREA_40[NUMBER_OF_CORES];
static volatile uint32 reentry_guard_PWM_EXCLUSIVE_AREA_40[NUMBER_OF_CORES];
static volatile uint32 msr_PWM_EXCLUSIVE_AREA_41[NUMBER_OF_CORES];
static volatile uint32 reentry_guard_PWM_EXCLUSIVE_AREA_41[NUMBER_OF_CORES];
static volatile uint32 msr_PWM_EXCLUSIVE_AREA_42[NUMBER_OF_CORES];
static volatile uint32 reentry_guard_PWM_EXCLUSIVE_AREA_42[NUMBER_OF_CORES];
static volatile uint32 msr_PWM_EXCLUSIVE_AREA_43[NUMBER_OF_CORES];
static volatile uint32 reentry_guard_PWM_EXCLUSIVE_AREA_43[NUMBER_OF_CORES];
static volatile uint32 msr_PWM_EXCLUSIVE_AREA_44[NUMBER_OF_CORES];
static volatile uint32 reentry_guard_PWM_EXCLUSIVE_AREA_44[NUMBER_OF_CORES];
static volatile uint32 msr_PWM_EXCLUSIVE_AREA_45[NUMBER_OF_CORES];
static volatile uint32 reentry_guard_PWM_EXCLUSIVE_AREA_45[NUMBER_OF_CORES];
static volatile uint32 msr_PWM_EXCLUSIVE_AREA_50[NUMBER_OF_CORES];
static volatile uint32 reentry_guard_PWM_EXCLUSIVE_AREA_50[NUMBER_OF_CORES];
static volatile uint32 msr_PWM_EXCLUSIVE_AREA_51[NUMBER_OF_CORES];
static volatile uint32 reentry_guard_PWM_EXCLUSIVE_AREA_51[NUMBER_OF_CORES];
static volatile uint32 msr_PWM_EXCLUSIVE_AREA_52[NUMBER_OF_CORES];
static volatile uint32 reentry_guard_PWM_EXCLUSIVE_AREA_52[NUMBER_OF_CORES];
static volatile uint32 msr_PWM_EXCLUSIVE_AREA_53[NUMBER_OF_CORES];
static volatile uint32 reentry_guard_PWM_EXCLUSIVE_AREA_53[NUMBER_OF_CORES];
static volatile uint32 msr_PWM_EXCLUSIVE_AREA_54[NUMBER_OF_CORES];
static volatile uint32 reentry_guard_PWM_EXCLUSIVE_AREA_54[NUMBER_OF_CORES];
static volatile uint32 msr_PWM_EXCLUSIVE_AREA_55[NUMBER_OF_CORES];
static volatile uint32 reentry_guard_PWM_EXCLUSIVE_AREA_55[NUMBER_OF_CORES];
static volatile uint32 msr_PWM_EXCLUSIVE_AREA_56[NUMBER_OF_CORES];
static volatile uint32 reentry_guard_PWM_EXCLUSIVE_AREA_56[NUMBER_OF_CORES];
static volatile uint32 msr_PWM_EXCLUSIVE_AREA_57[NUMBER_OF_CORES];
static volatile uint32 reentry_guard_PWM_EXCLUSIVE_AREA_57[NUMBER_OF_CORES];
static volatile uint32 msr_PWM_EXCLUSIVE_AREA_58[NUMBER_OF_CORES];
static volatile uint32 reentry_guard_PWM_EXCLUSIVE_AREA_58[NUMBER_OF_CORES];
static volatile uint32 msr_PWM_EXCLUSIVE_AREA_59[NUMBER_OF_CORES];
static volatile uint32 reentry_guard_PWM_EXCLUSIVE_AREA_59[NUMBER_OF_CORES];
static volatile uint32 msr_PWM_EXCLUSIVE_AREA_60[NUMBER_OF_CORES];
static volatile uint32 reentry_guard_PWM_EXCLUSIVE_AREA_60[NUMBER_OF_CORES];
static volatile uint32 msr_PWM_EXCLUSIVE_AREA_61[NUMBER_OF_CORES];
static volatile uint32 reentry_guard_PWM_EXCLUSIVE_AREA_61[NUMBER_OF_CORES];
static volatile uint32 msr_PWM_EXCLUSIVE_AREA_62[NUMBER_OF_CORES];
static volatile uint32 reentry_guard_PWM_EXCLUSIVE_AREA_62[NUMBER_OF_CORES];
static volatile uint32 msr_PWM_EXCLUSIVE_AREA_63[NUMBER_OF_CORES];
static volatile uint32 reentry_guard_PWM_EXCLUSIVE_AREA_63[NUMBER_OF_CORES];
static volatile uint32 msr_PWM_EXCLUSIVE_AREA_64[NUMBER_OF_CORES];
static volatile uint32 reentry_guard_PWM_EXCLUSIVE_AREA_64[NUMBER_OF_CORES];
static volatile uint32 msr_PWM_EXCLUSIVE_AREA_65[NUMBER_OF_CORES];
static volatile uint32 reentry_guard_PWM_EXCLUSIVE_AREA_65[NUMBER_OF_CORES];
static volatile uint32 msr_PWM_EXCLUSIVE_AREA_66[NUMBER_OF_CORES];
static volatile uint32 reentry_guard_PWM_EXCLUSIVE_AREA_66[NUMBER_OF_CORES];
