...
#define UART_IPW_AR_RELEASE_MINOR_VERSION_C     9
#define UART_IPW_AR_RELEASE_REVISION_VERSION_C  0
#define UART_IPW_SW_MAJOR_VERSION_C             7
#define UART_IPW_SW_MINOR_VERSION_C             0
#define UART_IPW_SW_PATCH_VERSION_C             1
...
static uint8 Uart_Ipw_s8HwMapping[UART_NUMBER_OF_INSTANCES] = UART_HW_CHANNELS_MAPPING_FOR_INIT;
...
void Uart_Ipw_Init(uint8 Channel, const Uart_Ipw_HwConfigType* Config)
{
...
#ifdef UART_IPW_LPUART_HW_USING
    #if (UART_CALLBACK_DECLARED == STD_ON)
        Uart_Ipw_s8HwMapping[HwUnit] = Channel;
    #endif /* UART_CALLBACK_DECLARED == STD_ON */
    ...
    {
    #if (UART_CALLBACK_DECLARED == STD_ON)
        Uart_Ipw_s8HwMapping[UART_NUMBER_OF_INSTANCES - FLEXIO_UART_IP_NUMBER_OF_SHIFTER_AND_TIMER + HwUnit] = Channel;
    #endif /* UART_CALLBACK_DECLARED == STD_ON */
...
void Uart_Ipw_Deinit(uint8 Channel)
{
    ...
    if (LPUART_IP == Uart_Ipw_apChnConfig[Channel]->UartIpType)
    {
        ...
        Uart_Ipw_s8HwMapping[HwUnit] = 255U;
    #endif /* UART_CALLBACK_DECLARED == STD_ON */
    ...
    #if (UART_CALLBACK_DECLARED == STD_ON)
        /* Remove the current hw to logic mapping */
        Uart_Ipw_s8HwMapping[UART_NUMBER_OF_INSTANCES - FLEXIO_UART_IP_NUMBER_OF_SHIFTER_AND_TIMER + HwUnit] = 255U;
    #endif /* UART_CALLBACK_DECLARED == STD_ON */
...
{
    uint8 Channel = Uart_Ipw_s8HwMapping[UART_NUMBER_OF_INSTANCES - FLEXIO_UART_IP_NUMBER_OF_SHIFTER_AND_TIMER + HwChannel];
