...
#define LCU_IP_IRQ_AR_RELEASE_MINOR_VERSION_C        9
#define LCU_IP_IRQ_AR_RELEASE_REVISION_VERSION_C     0
#define LCU_IP_IRQ_SW_MAJOR_VERSION_C                7
#define LCU_IP_IRQ_SW_MINOR_VERSION_C                0
#define LCU_IP_IRQ_SW_PATCH_VERSION_C                1
...
#if (STD_ON == LCU_IP_MULTIPARTITION_IS_AVAILABLE)
/* Check if Lcu_Ip_Irq.c file and Lcu_Ip_Multipartition.h file are of the same vendor */
#if (LCU_IP_IRQ_VENDOR_ID_C != LCU_IP_MULTIPARTITION_VENDOR_ID)
    #error "Lcu_Ip_Irq.c and Lcu_Ip_Multipartition.h have different vendor ids"
#endif

/* Check if Lcu_Ip_Irq.c file and Lcu_Ip_Multipartition.h file are of the same Autosar version */
#if ((LCU_IP_IRQ_AR_RELEASE_MAJOR_VERSION_C != LCU_IP_MULTIPARTITION_AR_RELEASE_MAJOR_VERSION) || \
     (LCU_IP_IRQ_AR_RELEASE_MINOR_VERSION_C != LCU_IP_MULTIPARTITION_AR_RELEASE_MINOR_VERSION) || \
     (LCU_IP_IRQ_AR_RELEASE_REVISION_VERSION_C != LCU_IP_MULTIPARTITION_AR_RELEASE_REVISION_VERSION) \
    )
    #error "AutoSar Version Numbers of Lcu_Ip_Irq.c and Lcu_Ip_Multipartition.h are different"
#endif

/* Check if Lcu_Ip_Irq.c file and Lcu_Ip_Multipartition.h file are of the same Software version */
#if ((LCU_IP_IRQ_SW_MAJOR_VERSION_C != LCU_IP_MULTIPARTITION_SW_MAJOR_VERSION) || \
     (LCU_IP_IRQ_SW_MINOR_VERSION_C != LCU_IP_MULTIPARTITION_SW_MINOR_VERSION) || \
     (LCU_IP_IRQ_SW_PATCH_VERSION_C != LCU_IP_MULTIPARTITION_SW_PATCH_VERSION) \
    )
    #error "Software Version Numbers of Lcu_Ip_Irq.c and Lcu_Ip_Multipartition.h are different"
#endif
#endif /* STD_ON == LCU_IP_MULTIPARTITION_IS_AVAILABLE */
