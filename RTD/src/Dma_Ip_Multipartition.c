...
#define DMA_IP_MULTIPARTITION_AR_RELEASE_MINOR_VERSION_C        9
#define DMA_IP_MULTIPARTITION_AR_RELEASE_REVISION_VERSION_C     0
#define DMA_IP_MULTIPARTITION_SW_MAJOR_VERSION_C                7
#define DMA_IP_MULTIPARTITION_SW_MINOR_VERSION_C                0
#define DMA_IP_MULTIPARTITION_SW_PATCH_VERSION_C                1
