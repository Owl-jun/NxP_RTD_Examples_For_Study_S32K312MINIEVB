...
#define FLEXIO_MCL_IP_HWACCESS_AR_RELEASE_MINOR_VERSION_C       9
#define FLEXIO_MCL_IP_HWACCESS_AR_RELEASE_REVISION_VERSION_C    0
#define FLEXIO_MCL_IP_HWACCESS_SW_MAJOR_VERSION_C               7
#define FLEXIO_MCL_IP_HWACCESS_SW_MINOR_VERSION_C               0
#define FLEXIO_MCL_IP_HWACCESS_SW_PATCH_VERSION_C               1
...
{
    baseAddr->SHIFTSTAT = FLEXIO_SHIFTSTAT_SSF(1UL << shifter);
}
