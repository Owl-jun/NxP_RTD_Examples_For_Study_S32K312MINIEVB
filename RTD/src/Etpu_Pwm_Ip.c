...
#define ETPU_PWM_IP_AR_RELEASE_MINOR_VERSION_C      9
#define ETPU_PWM_IP_AR_RELEASE_REVISION_VERSION_C   0
#define ETPU_PWM_IP_SW_MAJOR_VERSION_C              7
#define ETPU_PWM_IP_SW_MINOR_VERSION_C              0
#define ETPU_PWM_IP_SW_PATCH_VERSION_C              1
...
Etpu_Ip_ErrorType Etpu_Pwm_Ip_Init(Etpu_Pwm_Ip_InstanceType *pPwmInstance,
                                   const Etpu_Pwm_Ip_ConfigType *pPwmConfig)
{
    ...
    if (ETPU_ERROR_NONE == eErrorCode)
    {
        ...
        /* Enable channel */
        Etpu_Ip_EnableChannel(pPwmInstance->u8Channel, pPwmInstance->ePriority);
...
/*================================================================================================*/
void Etpu_Pwm_Ip_UpdateDuty(const Etpu_Pwm_Ip_InstanceType *pPwmInstance,
                            const Etpu_Pwm_Ip_ConfigType *pPwmConfig)
{
...
/*================================================================================================*/
void Etpu_Pwm_Ip_UpdateDutyImmed(const Etpu_Pwm_Ip_InstanceType *pPwmInstance,
                                 const Etpu_Pwm_Ip_ConfigType *pPwmConfig)
{
    Etpu_Ip_Uint24Type u24ChannelPeriod;
    uint8 u8EtpuEng = (uint8)ETPU_PWM_IP_GET_ENGINE(pPwmInstance->u8Channel);
...
/*================================================================================================*/
Etpu_Ip_ErrorType Etpu_Pwm_Ip_Update(const Etpu_Pwm_Ip_InstanceType *pPwmInstance,
                                     const Etpu_Pwm_Ip_ConfigType *pPwmConfig)
{
...
/*================================================================================================*/
void Etpu_Pwm_Ip_UpdateInterruptMode(const Etpu_Pwm_Ip_InstanceType *pPwmInstance,
                                     const Etpu_Pwm_Ip_ConfigType *pPwmConfig)
{
...
/*================================================================================================*/
Etpu_Ip_Uint24Type Etpu_Pwm_Ip_GetPeriod(const Etpu_Pwm_Ip_InstanceType *pPwmInstance)
{
    return Etpu_Ip_ReadU24Param(pPwmInstance->pCpba, ETPU_PWM_IP_OFFSET_PERIOD);
}

/*================================================================================================*/
uint16 Etpu_Pwm_Ip_GetDuty(const Etpu_Pwm_Ip_InstanceType *pPwmInstance)
{
    Etpu_Ip_Uint24Type u24ChannelPeriod;
...
/*================================================================================================*/
Etpu_Pwm_Ip_LastInterruptType Etpu_Pwm_Ip_GetLastInterrupt(const Etpu_Pwm_Ip_InstanceType *pPwmInstance)
{
