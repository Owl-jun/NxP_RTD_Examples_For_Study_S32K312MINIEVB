...
#define SCHM_WDG_AR_RELEASE_MINOR_VERSION_C     9
#define SCHM_WDG_AR_RELEASE_REVISION_VERSION_C  0
#define SCHM_WDG_SW_MAJOR_VERSION_C             7
...
static volatile uint32 msr_WDG_EXCLUSIVE_AREA_15[NUMBER_OF_CORES];
static volatile uint32 reentry_guard_WDG_EXCLUSIVE_AREA_15[NUMBER_OF_CORES];
static volatile uint32 msr_WDG_EXCLUSIVE_AREA_16[NUMBER_OF_CORES];
static volatile uint32 reentry_guard_WDG_EXCLUSIVE_AREA_16[NUMBER_OF_CORES];
...
void SchM_Enter_Wdg_WDG_EXCLUSIVE_AREA_15(void)
{
    ...
    if(0UL == reentry_guard_WDG_EXCLUSIVE_AREA_15[u32CoreId])
    {
#if (defined MCAL_ENABLE_USER_MODE_SUPPORT)
        msr = OsIf_Trusted_Call_Return(Wdg_schm_read_msr);
#else
        ...
        msr_WDG_EXCLUSIVE_AREA_15[u32CoreId] = msr;
    }
    reentry_guard_WDG_EXCLUSIVE_AREA_15[u32CoreId]++;
}
...
void SchM_Exit_Wdg_WDG_EXCLUSIVE_AREA_15(void)
{
    ...
    reentry_guard_WDG_EXCLUSIVE_AREA_15[u32CoreId]--;
    if ((ISR_ON(msr_WDG_EXCLUSIVE_AREA_15[u32CoreId]))&&(0UL == reentry_guard_WDG_EXCLUSIVE_AREA_15[u32CoreId]))         /*if interrupts were enabled*/
    {
        OsIf_ResumeAllInterrupts();
#ifdef _ARM_DS5_C_S32K3XX_
        ASM_KEYWORD(" nop ");/* Compiler fix - forces the CSPID instruction to be generated with -02, -Ospace are selected*/
...
void SchM_Enter_Wdg_WDG_EXCLUSIVE_AREA_16(void)
{
    ...
    if(0UL == reentry_guard_WDG_EXCLUSIVE_AREA_16[u32CoreId])
    {
#if (defined MCAL_ENABLE_USER_MODE_SUPPORT)
        msr = OsIf_Trusted_Call_Return(Wdg_schm_read_msr);
#else
        ...
        msr_WDG_EXCLUSIVE_AREA_16[u32CoreId] = msr;
    }
    reentry_guard_WDG_EXCLUSIVE_AREA_16[u32CoreId]++;
}
...
void SchM_Exit_Wdg_WDG_EXCLUSIVE_AREA_16(void)
{
    ...
    reentry_guard_WDG_EXCLUSIVE_AREA_16[u32CoreId]--;
    if ((ISR_ON(msr_WDG_EXCLUSIVE_AREA_16[u32CoreId]))&&(0UL == reentry_guard_WDG_EXCLUSIVE_AREA_16[u32CoreId]))         /*if interrupts were enabled*/
    {
        OsIf_ResumeAllInterrupts();
#ifdef _ARM_DS5_C_S32K3XX_
        ASM_KEYWORD(" nop ");/* Compiler fix - forces the CSPID instruction to be generated with -02, -Ospace are selected*/
...
void SchM_Check_wdg(void)
{
    ...
    EU_ASSERT(0UL == reentry_guard_WDG_EXCLUSIVE_AREA_15[u32CoreId]);
    reentry_guard_WDG_EXCLUSIVE_AREA_15[u32CoreId] = 0UL; /*reset reentry_guard_WDG_EXCLUSIVE_AREA_15 for the next test in the suite*/

    EU_ASSERT(0UL == reentry_guard_WDG_EXCLUSIVE_AREA_16[u32CoreId]);
    reentry_guard_WDG_EXCLUSIVE_AREA_16[u32CoreId] = 0UL; /*reset reentry_guard_WDG_EXCLUSIVE_AREA_16 for the next test in the suite*/
